int cvi_board_init(void)
{
	...
	// EMEB - need these for LCD control on audio board
	PINMUX_CONFIG(SD1_D2, PWR_GPIO_19);	// DC
	PINMUX_CONFIG(SD1_D1, PWR_GPIO_20);	// RESET
	PINMUX_CONFIG(SD1_GPIO1, PWR_GPIO_26);	// LED
